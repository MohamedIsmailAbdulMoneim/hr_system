    ...
    */
    ...
    handelEdit_2 = (e) => {
        ...
        axios({
            method: "PUT",
            data: data,
            url: `http://${process.env.REACT_APP_URL}/editempedu`,
                                ...
                                <div style={{ height: "100%", minHeight: 250, width: "50%", minWidth: "750px", overflow: "auto" }} class="panel panel-default">
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-around" }}>
                                        ...
                                        <div className="form-group" controlId="formBasicEmail">
                                            ...
                                            <input ref="nameadd" onKeyUp={this.nameInputHandlerForAdd} id="nameinputadd" className="form-control" style={{ width: "100%", minWidth: "250px" }} type="text" />
                                        </div>
                                    </div>
...
export default connect(mapStateToProps, {
    getEmpEdu, getEmpName, getEmpNameByName, InsertNewEdu,globalNameOrId
})((EmpEduDeg));